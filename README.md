...
To support further research on prompt–image relationships and multimodal representations, we release a large-scale collection of anonymized prompts and corresponding image embeddings. Raw images are not released due to platform terms of service, copyright considerations, and potential misuse risks.
